    ...
    <section id="calculator" className="bg-navy py-24">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="coastal-card bg-navy-soft p-8 space-y-6">
            <label className="flex flex-col gap-2">
              <span className="flex items-baseline justify-between text-xs font-semibold uppercase tracking-widest text-cream/50">
                Home Value
                <span className="font-display text-base normal-case tracking-normal text-cream">
                  {currency(homeValue)}
                </span>
              </span>
              <input
            ...
            <label className="flex flex-col gap-2">
              ...
              <select
                ...
                className="rounded-xl px-4 py-3 bg-navy text-cream text-sm border border-cream/15 focus:border-rope outline-0"
              >
                {FLOOD_ZONES.map((z) => (
          ...
          <div className="coastal-card bg-sand p-8 flex flex-col justify-center gap-6">
            <div>
              <span className="text-xs font-semibold uppercase tracking-widest text-rope-deep">
                Estimated Annual Insurance
              </span>
              <div className="font-display text-4xl text-navy mt-2">
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 border-t border-navy/10">
              ...
              <div>
                <span className="block font-display text-xl text-seafoam">
        ...
        <div className="mt-8 coastal-card bg-navy-soft flex flex-col sm:flex-row items-center justify-between gap-6 p-8">
          <div>
